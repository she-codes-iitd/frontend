...
import AssignmentAdd from "./components/Mentor/AssignmentAdd";
import QuizStats from "./components/Mentor/QuizStats";
  ...
  return (
    <div onClick={closeHamburger}>
      <Routes>
        ...
        />
        <Route
          path="/ongoing/currtopic/assignment"
          element={
            <AssignmentMentor
              logo={logo}
              hamburger={hamburger}
        ...
        />
        <Route
          path="/ongoing/currtopic/assignment/add"
          element={
            <AssignmentAdd
              logo={logo}
              hamburger={hamburger}
        ...
        />
        <Route
          path="/ongoing/currtopic/quiz/stats"
          element={
            <QuizStats
              logo={logo}
              hamburger={hamburger}
